        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="#">
                ...
                <p class='text-sm font-light leading-tight'>
                    Don't have account? <a href="#" class="text-primary-600 text-indigo-400 hover:underline hover:text-indigo-700 dark:text-primary-500">Sign up</a>
                </p>
                <button type="submit" class="w-full text-white bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 hover:from-indigo-500 hover:from-10% hover:via-sky-500 hover:via-30% hover:to-emerald-400 focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Log in</button>
            </form>
        </div>
    </div>
  </div>
